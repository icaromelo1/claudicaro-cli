...
const CLI_META: Record<string, { name: string; color: string; bg: string }> = {
  ...
  agy: { name: 'Agy', color: '#5187F2', bg: 'rgba(81,135,242,0.12)' },
...
const CLI_GLYPHS: Record<string, string> = {
  ...
  agy: `<path fill="currentColor" d="M12 24A14.304 14.304 0 0 0 0 12 14.304 14.304 0 0 0 12 0a14.305 14.305 0 0 0 12 12 14.305 14.305 0 0 0-12 12"/>`,
...
const cliInitial = computed(() => {
  const labels: Record<string, string> = { claude: 'C', agy: 'G', copilot: 'P' }
...
const routingMeta = computed(() => props.message.routingMeta ?? null)
